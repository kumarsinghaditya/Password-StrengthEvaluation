...
nordpass = Flask(__name__)
port = int(os.environ.get('PORT', 4000))
nordpass.config['SECRET_KEY'] = 'abc123@567$#'

def callEnzoicAPI(password):
    apiKey = 'ae2619bf3a594ebfb12c225c3d26226d'
    secretKey = 'Ap516zeVa6=-=S&W8Y=Knz41rqQsnkSu'
...
@nordpass.route('/main/', methods=['GET', 'POST'])
def mainpage():
...
if __name__ == "__main__":
    nordpass.run(host='0.0.0.0', port=port, debug=True)
